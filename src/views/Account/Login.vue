      ...
      <div class="row">
        <div class="input-field col s12">
          <input
            id="username"
            type="text"
            v-model="authData.testar"
            @keyup="usernameKeyUpHandler($event)"
          />
        ...
        <div class="input-field col s12">
          <input
            ...
            ref="passwordInput"
            @keyup="passwordKeyUpHandler($event)"
          />
...
export default {
  ...
  methods: {
    ...
    loginClickHandler() {
      ...
      if (
        this.authData.testar.length < 1 ||
        this.authData.password.length < 1
      ) {
        this.errors.push("Empty fields!");
        this.authData.password = "";
      } else {
        this.$store
          .dispatch("users/loginUser", this.authData)
          .then(() => {
